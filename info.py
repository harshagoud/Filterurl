...
BOT_TOKEN = environ.get('BOT_TOKEN', '6137983745:AAFzqxcMlOnbSFrHd3ZgGb_yyh9VC4bmnts')
# Bot settings
...
DATABASE_NAME = environ.get('DATABASE_NAME', "cinesfggggilhhhhes")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'cineshhhandhvhgggadi01')
